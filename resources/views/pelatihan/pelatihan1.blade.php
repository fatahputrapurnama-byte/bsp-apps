...
@section('container')
    <header class="masthead" style="background-image: url('../assets/img/training/{{ $trainingDetail->image }}');">
        <div class="container">
            {{-- <div class="masthead-subheading">Welcome fellas!</div> --}}
            <div class="masthead-heading text-uppercase">{{ $trainingDetail->title }}</div>
            <h2>{{ $trainingDetail->subtitle }}</h2>
            {{-- <a class="btn btn-primary btn-xl text-uppercase" href="#portfolio">Tell Me More</a> --}}
        </div>
    </header>
    <style>
    .trix-output-container div {
        text-align: justify;
    }
</style>
            ...
            <div class="col-sm-4" style="text-align:justify;">
                <table border="1" style="width:90%">
                    ...
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div class="">
                              <p align="justify">{!! $trainingDetail->paket !!}</p>
                ...
                <table border="1" style="background-color: aliceblue; width:90%">
                    <th style="padding:15px;">
                        <h3 style="margin-top: 20px;"><strong>Unduhan</strong></h3>
                    </th>
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div style="margin-bottom: 20px;">
                                <a href="{{ asset('assets/img/training/brosur/' .$trainingDetail->image_brosur ) }}" target="_blank">
                                <button class="btn btn-primary btn-l text-uppercase" id="submitButton" type="submit">Unduh Brosur</button>
                                </a>
                                <br><br>
                                <a href="{{ asset('assets/img/training/jadwal/' .$trainingDetail->image_jadwal ) }}" target="_blank">
                                <button class="btn btn-primary btn-l text-uppercase" id="submitButton" type="submit">Unduh Jadwal</button>
                                </a>
                            </div>
                        </td>
                    </tr>
