...
@section('container')
    <header class="masthead" style="background-image: url('../assets/img/bimtek/{{ $bimtekDetail->image }}');">
        <div class="container">
            {{-- <div class="masthead-subheading">Welcome fellas!</div> --}}
            <div class="masthead-heading text-uppercase">{{ $bimtekDetail->title }}</div>
            <h2>{{ $bimtekDetail->subtitle }}</h2>
    ...
    <div class="container mt-3">
        <div class="row justify-content-center mb-5">
            <div class="col-sm-4" style="text-align:justify;">
                <h4 style="text-align:left;">{{ $bimtekDetail->title }}</h4>
                <p>
                    {!! $bimtekDetail->body !!}
                </p>
            </div>
                ...
                <table border="1" style="width:90%">
                    ...
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div class="">
                              <p align="justify">{!! $bimtekDetail->paket !!}</p>
                    ...
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div style="margin-bottom: 30px;">
                                <a href="{{ asset('assets/img/bimtek/brosur/' .$bimtekDetail->image_brosur ) }}" target="_blank">
