...
@section('container')
   <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="col-lg-8">
          <form method="post" action="{{ url('dashboard/auditing') }}" enctype="multipart/form-data">
            @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('title') is-invalid @enderror" id="subtitle" name="subtitle" autofocus value="{{ old("subtitle") }}">
                  @error('subtitle')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div> 
