...
@section('container')
    <header class="masthead" style="background-image: url('../assets/img/auditing/{{ $auditingDetail->image }}');">
        <div class="container">
            {{-- <div class="masthead-subheading">Welcome fellas!</div> --}}
            <div class="masthead-heading text-uppercase">{{ $auditingDetail->title }}</div>
            <h2>{{ $auditingDetail->subtitle }}</h2>
    ...
    <div class="container mt-3">
        <div class="row justify-content-center mb-5">
            <div class="col-sm-4" style="text-align:justify;">
                <h4 style="text-align:left;">{{ $auditingDetail->title }}</h4>
                <p>
                    {!! $auditingDetail->body !!}
                </p>
            </div>
                    ...
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div style="margin-bottom: 30px;">
                                <a href="{{ asset('assets/img/auditing/brosur/' .$auditingDetail->image_brosur ) }}" target="_blank">
