...
@section('container')
    <header class="masthead" style="background-image: url('../assets/img/kajianstudy/{{ $kajianstudyDetail->image }}');">
        <div class="container">
            {{-- <div class="masthead-subheading">Welcome fellas!</div> --}}
            <div class="masthead-heading text-uppercase">{{ $kajianstudyDetail->title }}</div>
            <h2>{{ $kajianstudyDetail->subtitle }}</h2>
    ...
    <div class="container mt-3">
        <div class="row justify-content-center mb-5">
            <div class="col-sm-4" style="text-align:justify;">
                <h4 style="text-align:left;">{{ $kajianstudyDetail->title }}</h4>
                <p>
                    {!! $kajianstudyDetail->body !!}
                </p>
            </div>
            <div class="col-sm-4" style="text-align:justify;">
                <h4>Manfaat</h4>
                {!! $kajianstudyDetail->advantage !!}
            </div>
            <div class="col-sm-4" style="text-align:justify;">
                <table border="1" style="width:90%">
                    <th style="background-color: #0071c2; padding:10px;">
                        <h4>Paket Kajian & Study</h4>
                    </th>
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div class="">
                              <p align="justify">{!! $kajianstudyDetail->paket !!}</p>
                    ...
                    <tr>
                        <td style="padding: 15px; background-color:aliceblue">
                            <div style="margin-bottom: 30px;">
                                <a href="{{ asset('assets/img/kajianstudy/brosur/' .$kajianstudyDetail->image_brosur ) }}" target="_blank">
